...
<p align="center">
  ...
  <img alt="Ringdown: zero dependencies" src="https://img.shields.io/badge/ringdown-zero%20dependencies-2f6f4e">
  <img alt="606 tests" src="https://img.shields.io/badge/tests-606-2f6f4e">
...
<details>
<summary><b>The ten scenarios</b> — what each one is there to break</summary>
...
| [`docs/audio/`](docs/audio/) | Generated by `demo/audio.py`: one track per scenario plus the manifest the site reads. Committed, because the site has no build step |
...
- **Almost every artefact in this repository was produced with one channel wearing two names.** The
  ...
  ten scenarios, the committed ledger and nearly the whole suite verify against the server that
